...
export default function SafetyLogPage() {
  const { logEntries, clearLog } = useSafetyLog();
  ...
  return (
    <div className="px-8 py-6">
      <div className="flex items-baseline gap-4 pb-6 border-b border-gray-200 mb-6">
        <h1 className="text-3xl font-light tracking-tight">Incident Log</h1>
          ...
          <div className="border border-gray-200 bg-white p-12 text-center">
            <div className="text-gray-400">
              ...
              <p className="text-xs mt-1">
                Incidents will appear here when Guardian detects safety concerns
              </p>
            </div>
          </div>
        ) : (
